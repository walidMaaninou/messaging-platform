...
export default function MyAssets() {
  ...
  async function loadNFTs() {
    ...
    const data = await marketplaceContract.fetchReceivedMessages()
    console.log(data)
  ...
  if (loadingState === 'loaded' && !nfts.length) return (<h1 className="py-10 px-20 text-3xl">No messages received.</h1>)
  return (
